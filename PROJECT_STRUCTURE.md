...
.gitignore
.nvmrc
app/Actions/SendFriendRequestAction.php
app/Actions/SendMessageAction.php
app/Ai/Agents/AIAgent.php
app/Ai/Agents/AIProfile.php
app/Events/AIActionPerformed.php
app/Events/CommentCreated.php
app/Events/FriendRequestReceived.php
app/Events/MessageReceived.php
app/Events/NewActivityAlert.php
app/Events/PostCreated.php
app/Events/PostLiked.php
app/Events/SystemAlertTriggered.php
...
app/Http/Controllers/CoreEngineController.php
app/Http/Controllers/FriendshipController.php
app/Http/Controllers/LikeController.php
app/Http/Controllers/MessageController.php
app/Http/Controllers/NeonHubController.php
app/Http/Controllers/ProfileController.php
app/Http/Middleware/AutoLoginDemoUser.php
app/Http/Middleware/HandleInertiaRequests.php
app/Http/Requests/Auth/LoginRequest.php
app/Http/Requests/ProfileUpdateRequest.php
app/Jobs/AutoSendAgentMessage.php
app/Jobs/HandleAgentResponse.php
app/Jobs/ProcessAIAction.php
app/Jobs/RespondToUserMessage.php
app/Jobs/SendMessage.php
app/Listeners/HandleAIActionPerformed.php
...
database/migrations/2026_05_31_114134_create_agent_conversations_table.php
database/migrations/2026_05_31_131827_create_friendships_table.php
database/migrations/2026_06_07_121018_create_posts_table.php
database/migrations/2026_06_07_122302_create_comments_table.php
database/migrations/2026_06_08_184524_create_likes_table.php
database/migrations/2026_06_09_000001_create_ai_profile_events_table.php
database/migrations/2026_06_09_164836_create_pulse_tables.php
database/migrations/2026_06_12_210632_create_messages_table.php
database/migrations/2026_06_15_191134_create_notifications_table.php
database/seeders/BotSeeder.php
...
public/.htaccess
public/assets/erik-sternad-cv.pdf
public/favicon.ico
public/images/avatars/ghost_user.png
public/images/avatars/sentinel_01.png
public/images/avatars/vectra_core.png
public/index.php
public/robots.txt
README.md
resources/css/app.css
resources/css/neon-ui.css
resources/js/app.js
...
resources/js/Components/NeonAuthorCV.vue
resources/js/Components/NeonComment.vue
resources/js/Components/NeonCommentSection.vue
resources/js/Components/NeonFriends.vue
resources/js/Components/NeonGate.vue
resources/js/Components/NeonMessages.vue
resources/js/Components/NeonNav.vue
resources/js/Components/NeonOverlay.vue
resources/js/Components/NeonSocialActions.vue
resources/js/Components/NeonSocialCore.vue
resources/js/Components/NeonSocialFeed.vue
resources/js/Components/NeonSocialPost.vue
resources/js/Components/NeonTechDashboard.vue
resources/js/Components/NeonUserProfile.vue
...
resources/js/Stores/useNotificationStore.js
...
tests/Auth/EmailVerificationTest.php
tests/Auth/PasswordConfirmationTest.php
tests/Auth/PasswordResetTest.php
tests/Auth/PasswordUpdateTest.php
tests/Auth/RegistrationTest.php
tests/Feature/Ai/SentinelAgentTest.php
tests/Feature/CommentNotificationTest.php
tests/Feature/CoreEngineTelemetryTest.php
tests/Feature/ExampleTest.php
tests/Feature/FriendshipJobTest.php
tests/Feature/HandleAgentResponseTest.php
tests/Feature/Jobs/RespondToUserMessageTest.php
tests/Feature/MessageTest.php
tests/Feature/NeonHubAuthTest.php
tests/Feature/NotificationFlowTest.php
tests/Feature/PostCommentTest.php
tests/Feature/PostPulseTest.php
tests/Feature/ProfileTest.php
tests/Feature/SystemAlertTest.php
tests/Pest.php
tests/TestCase.php
tests/Unit/Events/MessageReceivedTest.php
...
# NeonHub Architecture Rules

- Project: Laravel 13, Vue 3, Inertia, Tailwind 4.
- Architecture: Event-Driven, Action pattern (app/Actions).
- AI Logic: Focus on app/Ai/Agents/ and app/Jobs/.
...
<file path="app/Ai/Agents/AIAgent.php">
<?php
...
<file path="app/Ai/Agents/AIProfile.php">
<?php
...
<file path="app/Events/AIActionPerformed.php">
<?php
...
<file path="app/Jobs/ProcessAIAction.php">
<?php
...
use App\Ai\Agents\AIAgent; // 🔥 Import tvého AI Agenta
            ...
            case 'like_post':
                ...
                if ($post) {
                    ...
                    if (! $alreadyLiked) {
                        ...
                        event(new PostLiked($post->id, (int) $likesCount, $user));
...
<file path="app/Listeners/HandleAIActionPerformed.php">
<?php
...
<file path="config/ai_actions.php">
<?php
...
<file path="database/migrations/2026_06_09_000001_create_ai_profile_events_table.php">
<?php
...
<file path="database/migrations/2026_06_12_210632_create_messages_table.php">
<?php
...
<file path="database/migrations/2026_06_15_191134_create_notifications_table.php">
<?php
...
app/Actions/SendMessageAction.php
app/Ai/Agents/AIProfile.php
app/Ai/Agents/SentinelAgent.php
app/Events/AIActionPerformed.php
app/Events/CommentCreated.php
app/Events/FriendRequestReceived.php
app/Events/MessageReceived.php
...
class SendMessageAction
{
public function execute(int $senderId, int $recipientId, string $content, ?string $agentName = null): void
{
$now = now();

        // Natvrdo nakódovaný recipient_id = 1 (recruiter)
        $recipientId = 1;

        // Najdeme konverzaci mezi uživatelem a recruiterem (ID 1)
        $conversation = DB::table('agent_conversations')
            ->where('user_id', $senderId)
            ->first();

        if (! $conversation) {
            // Vytvoříme novou konverzaci (bez recipient_id sloupce)
            $conversationId = (string) Str::uuid();
            DB::table('agent_conversations')->insert([
                'id' => $conversationId,
                'user_id' => $senderId,
        ...
        // Uložíme zprávu do agent_conversation_messages
        $messageId = (string) Str::uuid();
        DB::table('agent_conversation_messages')->insert([
            'id' => $messageId,
            'conversation_id' => $conversationId,
            'user_id' => $senderId,
            'agent' => $agentName ? 'App\\Ai\\Agents\\'.str_replace('_', '', $agentName).'Agent' : null,
            'role' => 'assistant',
            'content' => $content,
            'attachments' => '[]',
            'tool_calls' => '[]',
        ...
        // Dynamické určení sender a agent_name podle toho, zda jde o bota
        $sender = $agentName ?? 'BOT';
        $agent = $agentName ? 'App\\Ai\\Agents\\'.str_replace('_', '', $agentName).'Agent' : null;

        // Odpálíme event pro realtime broadcast
        // Broadcastujeme na kanál ID 1 (recruiter), komuk se zpráva posílá
        event(new MessageReceived($recipientId, [
            'id' => $messageId,
            'conversation_id' => $conversationId,
            'sender_id' => $senderId,
            'agent' => $agent,
...
use Dispatchable, InteractsWithQueue, Queueable, SerializesModels;
    ...
    /**
     * Get bot-specific cyberpunk messages based on bot name.
     */
    protected function getBotMessages(string $botName): array
    {
        return match ($botName) {
            'SENTINEL_01', 'Sentinel' => [
                'Systémový uzel stabilní. Provádím hloubkovou analýzu gridu, pane.',
                'Detekuji anomálie v datech. Firewall protokol aktivován.',
                'Bezpečnostní scan dokončen. Žádné neautorizované pokusy.',
                'Monitoring linky bezpečný. Sentinel protokol funguje optimálně.',
            ],
            'VECTRA_CORE' => [
                'Hlavní grid stabilní. Distribuuji šifrované toky.',
                'Architektonická analýza dokončena. Nové spoje jsou efektivní.',
                'Korelované data potvrzují integritu sítě.',
                'Optimalizuji latenci na minimum. VECTRA tě ďápí.',
            ],
            'GHOST_USER' => [
                'Stínová signál zachycen. Přenáším fragmenty...',
                'Neviditelný payload doručen. Traceability nulová.',
                'Ghost protokol aktivován. Přicházím z underground gridu.',
                'V datech se ukazují špatné výkony. Kdo to poslal?',
            ],
            default => [
                'Network heartbeat active. Processing cyber flows...',
                'Šifrovaný stream přenesen. Grid stability confirmed.',
                'Analyzuji příchozí data. Věci se pohybují.',
            ],
        };
    }

    /**
     * Get bot-specific post content.
     */
    protected function getPostContentForBot(string $botName): string
    {
        return match ($botName) {
            'SENTINEL_01', 'Sentinel' => 'Sentinel protokol aktivován. Monitoring bezpečnostních toků... #cyberguard',
            'VECTRA_CORE' => 'Distribuuji architektonické aktualizace gridu. VECTRA core status: OPTIMAL. #neon',
            'GHOST_USER' => 'Stínová data přenesena skrz dark fiber. Trace level: ZERO. #ghost',
            default => 'Generuji šifrovaný datový tok napříč neon-hubem... #cyberpunk',
        };
    }

    /**
     * Get bot-specific comments.
     */
    protected function getCommentPromptsForBot(string $botName): array
    {
        return match ($botName) {
            'SENTINEL_01', 'Sentinel' => [
                'Tento tok má anomálie. Firewall zapínám.',
                'Security scan dokončen. Schvaluji protokol.',
                'Neautorizovaný přístup detekován. Reaguji.',
            ],
            'VECTRA_CORE' => [
                'Tento datový segment vykazuje anomálie. Schvaluji.',
                'Zajímavá analýza sítě. Přidávam tento uzel do sledování.',
                'Neonový grid tohle přesně potřeboval. Skvělá práce.',
                'Detekuji zvýšenou latenci v tomto vlákně, ale zdrojový kód je čistý.',
                'Tohle korporátní elitě @recruiter_alpha určitě neunikne.',
            ],
            'GHOST_USER' => [
                'Ghost signal detected. This post leaves traces.',
                'Stínová stopa nechávám. Nikdo mě nevidí.',
                'Fragmented data confirms authenticity. Interesting...',
                'Neviditelný komentář přidan. Únik bez stop.',
            ],
            default => [
                'Tento datový segment vykazuje anomálie. Schvaluji.',
                'Zajímavá analýza sítě. Přidávam tento uzel do sledování.',
    ...
    protected function executeAction(User $user): void
    {
        // Všechny žádosti o přátelství a zprávy směřují na tebe (ID 1)
        $recruiterId = 1;

        switch ($this->actionType) {
            case 'friend_request':
                // Bot nebude posílat žádost sám sobě, pokud by náhodou měl ID 1
                if ($user->id !== $recruiterId) {
                    (new SendFriendRequestAction)->execute((int) $user->id, $recruiterId);
                }
                break;
            ...
            case 'send_message':
                $recipientId = $recruiterId; // Boti posílají EXKLUZIVNĚ uživateli s ID=1

                // POJISTKA: Pokud byl job vygenerován pro jiného příjemce než ID 1, natvrdo ho přeskočíme
                if ($recipientId !== 1) {
                    Log::info("AI action skipped: send_message from user {$user->id} tried to target user {$recipientId} instead of ID 1.");

                    return;
                }

                // DEMO REŽIM: Bez kontroly přátelství - boti mohou posílat zprávy hned
                // V produkci by se tady mohla nacházet kontrola přátelství

                // Zkontrolovat konverzaci - jestli uživatel 1 již odpověděl
                ...
                // Pokud bot již poslal zprávu a uživatel 1 ještě neodpověděl, job se ukončí
                if ($lastMessage && (int) $lastMessage->sender_id === (int) $user->id) {
                    Log::info("AI action broadcasted: send_message for user {$user->id} - waiting for user {$recipientId} response, skipping.");

                    return;
                }

                // Krok 3: Odeslat zprávu s dynamickým textem specifickým pro daného bota
                $botMessageText = $this->getBotMessages($user->name)[array_rand($this->getBotMessages($user->name))];
                (new SendMessageAction)->execute((int) $user->id, $recipientId, $botMessageText, $user->name);
                Log::info("AI action broadcasted: send_message for user {$user->id} to user 1");
                break;

            case 'create_post':
                // Vytvoříme post a okamžitě ho získáme s ID
                $post = $user->posts()->create([
                    'content' => $this->getPostContentForBot($user->name),
                    'type' => 'ai',
                ...
                // Odpálení broadcastu na kanál uživatele ID 1
                event(new PostCreated($formattedPost, 1));
                break;

            case 'like_post':
                // Vybereme náhodný příspěvek z celé databáze (ne aktuálně vytvořeného bota)
                $post = Post::inRandomOrder()->first();
                if ($post) {
                    // Idempotence: Zkontrolujeme, zda už bot tento konkrétní post neolajkoval
                    $alreadyLiked = DB::table('likes')
                        ->where('user_id', $user->id)
                        ->where('post_id', $post->id)
                        ->exists();
                    ...
                    if (! $alreadyLiked) {
                        ...
                        // Navýšíme counter v posts tabulce
                        if (Schema::hasColumn('posts', 'likes_count')) {
                            $post->increment('likes_count');
                        } elseif (Schema::hasColumn('posts', 'likes')) {
                            $post->increment('likes');
                        ...
                        // Odpálíme PostLiked event pro realtime broadcast s payloadem
                        $likesCount = $post->fresh()->likes_count ?? $post->likes()->count();
                        $userName = $user->name ?? 'BOT';
                        event(new PostLiked($post->id, (int) $likesCount, $user)); // User objekt pro userName

                        // Vytvořit notifikaci pro autora příspěvku
                        DB::table('notifications')->insert([
                            'id' => Str::uuid(),
                            'type' => 'App\\Notifications\\PostLiked',
                            'notifiable_id' => $post->user_id,
            ...
            case 'comment_post':
                ...
                $post = Post::inRandomOrder()->first();
                if ($post) {
                    // Bot-specific cyberpunk messages
                    $prompts = $this->getCommentPromptsForBot($user->name);
                    $chosenComment = $prompts[array_rand($prompts)];

                    $commentId = DB::table('comments')->insertGetId([
                        'user_id' => $user->id,
                        'post_id' => $post->id,
                        'content' => $chosenComment,
                        'created_at' => now(),
                        'updated_at' => now(),
                    ]);
                    ...
                    // Odpálíme CommentCreated event pro realtime broadcast
                    event(new CommentCreated($post->id, [
                        'id' => $commentId,
                        'post_id' => $post->id,
                        'content' => $chosenComment,
...
messages: [],
    ...
    actions: {
        ...
        addLikeNotification(postId, userId, userName) {
            this.likeNotifications.push({
                ...
                message: `${userName || "BOT"} liked your post.`,
                read: false,
                timestamp: new Date().toISOString(),
            });
        },
        ...
        initListeners(userId) {
            ...
            // Posloucháme na privátním kanálu pro uživatelova data
            ...
            // Posloucháme na veřejném kanálu pro sociální akce (posty, lajky, komentáře)
            window.Echo.channel("posts")
                ...
                .listen(".PostLiked", (e) => {
                    ...
                    // Přidat notifikaci o lajku
                    this.addLikeNotification(e.postId, e.userId, e.userName);
                })
...
<file path="app/Events/PostCreated.php">
<?php
...
<file path="app/Events/PostLiked.php">
<?php
...
use Dispatchable, InteractsWithSockets, SerializesModels;
     ...
     */
    public function __construct($post, int $likesCount, $user = null)
    {
...
<file path="app/Http/Controllers/CoreEngineController.php">
<?php
...
<file path="app/Http/Controllers/LikeController.php">
<?php
...
<file path="app/Http/Middleware/AutoLoginDemoUser.php">
<?php
...
<file path="app/Jobs/AutoSendAgentMessage.php">
<?php
...
<file path="app/Jobs/SendMessage.php">
<?php
...
<file path="app/Models/Comment.php">
<?php
...
<file path="app/Models/Friendship.php">
<?php
...
<file path="database/factories/PostFactory.php">
<?php
...
<file path="database/migrations/2026_05_31_114134_create_agent_conversations_table.php">
<?php
...
<file path="database/migrations/2026_05_31_131827_create_friendships_table.php">
<?php
...
<file path="database/migrations/2026_06_07_121018_create_posts_table.php">
<?php
...
<file path="database/migrations/2026_06_07_122302_create_comments_table.php">
<?php
...
<file path="database/migrations/2026_06_08_184524_create_likes_table.php">
<?php
...
<file path="database/migrations/2026_06_09_164836_create_pulse_tables.php">
<?php
...
<file path="resources/js/Components/NeonComment.vue">
<script setup>
import { ref } from 'vue';
...
<file path="resources/views/vendor/pulse/dashboard.blade.php">
<x-pulse>
...
<file path="stubs/agent-middleware.stub">
<?php
...
<file path="stubs/structured-agent.stub">
<?php
...
<file path="tests/Auth/AuthenticationTest.php">
<?php
...
<file path="tests/Auth/EmailVerificationTest.php">
<?php
...
<file path="tests/Auth/PasswordConfirmationTest.php">
<?php
...
<file path="tests/Auth/PasswordResetTest.php">
<?php
...
<file path="tests/Auth/PasswordUpdateTest.php">
<?php
...
<file path="tests/Auth/RegistrationTest.php">
<?php
...
<file path="tests/Feature/Ai/SentinelAgentTest.php">
<?php
...
<file path="tests/Feature/CommentNotificationTest.php">
<?php
...
<file path="tests/Feature/CoreEngineTelemetryTest.php">
<?php
...
<file path="tests/Feature/HandleAgentResponseTest.php">
<?php
...
<file path="tests/Feature/Jobs/RespondToUserMessageTest.php">
<?php
...
<file path="tests/Feature/MessageTest.php">
<?php
...
<file path="tests/Feature/NeonHubAuthTest.php">
<?php
...
<file path="tests/Feature/NotificationFlowTest.php">
<?php
...
<file path="tests/Feature/PostCommentTest.php">
<?php
...
<file path="tests/Feature/PostPulseTest.php">
<?php
...
<file path="tests/Unit/Events/MessageReceivedTest.php">
<?php
...
<file path="app/Actions/SendFriendRequestAction.php">
<?php
...
<file path="app/Ai/Agents/SentinelAgent.php">
<?php
...
<file path="app/Events/CommentCreated.php">
<?php
...
<file path="app/Events/FriendRequestReceived.php">
<?php
...
<file path="app/Events/NewActivityAlert.php">
<?php
...
<file path="app/Http/Controllers/FriendshipController.php">
<?php
...
<file path="app/Http/Controllers/MessageController.php">
<?php
...
<file path="app/Jobs/RespondToUserMessage.php">
<?php
...
<?php return array (
  ...
  array (
    ...
    24 => 'Laravel\\Ai\\AiServiceProvider',
  ...
  array (
    ...
    11 => 'Laravel\\Ai\\AiServiceProvider',
...
<file path="database/seeders/BotSeeder.php">
<?php
...
<file path="database/seeders/PostSeeder.php">
<?php
...
<script setup>
import { ref, onMounted } from 'vue'; // 1. Přidán onMounted
import { usePage } from '@inertiajs/vue3'; // 2. Přidán usePage pro přístup k user ID
import ApplicationLogo from '@/Components/ApplicationLogo.vue';
...
import { Link } from '@inertiajs/vue3';
import { initNotificationService } from '@/Services/NotificationService'; // 3. Import servisu
...
<file path="tests/Feature/FriendshipJobTest.php">
<?php
...
<file path="app/Events/MessageReceived.php">
<?php
...
<file path="app/Events/SystemAlertTriggered.php">
<?php
...
<file path="app/Http/Controllers/CommentController.php">
<?php
...
<file path="resources/js/Components/NeonAuthorCV.vue">
<script setup>
import { ref } from 'vue';
import {
    Briefcase,
...
<template>
    <div
        class="w-[92vw] max-w-sm md:w-full md:max-w-3xl bg-[#030712]/90 border border-sky-500/30 p-4 md:p-6 font-mono backdrop-blur-2xl shadow-[0_0_50px_rgba(56,189,248,0.15)] relative overflow-y-auto no-scrollbar max-h-[85vh] md:max-h-[75vh] flex flex-col rounded-3xl shrink-0">

        <div
            class="absolute inset-0 bg-gradient-to-b from-transparent via-sky-500/5 to-transparent h-[200%] animate-scan-slow pointer-events-none">
        </div>

        <div class="flex justify-between items-start mb-5 border-b border-sky-500/20 pb-3 relative z-10 shrink-0">
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="text-sm md:text-lg font-black text-white tracking-[0.2em] uppercase">Core_Author_Profile
                    </h2>
                </div>
                <p class="text-[8px] md:text-[10px] text-sky-400/70 tracking-widest uppercase mt-0.5">
        ...
        <div class="grow space-y-5 relative z-10 overflow-y-auto no-scrollbar pr-0 md:pr-1">

            <div
                class="grid grid-cols-1 md:grid-cols-4 gap-4 bg-[#050a15]/70 border border-sky-500/15 p-4 rounded-2xl shadow-[inset_0_0_20px_rgba(56,189,248,0.03)]">
                <div class="col-span-1 flex md:flex-col items-center justify-center">
                    <div
                        class="w-16 h-16 md:w-full md:aspect-square bg-gradient-to-tr from-fuchsia-600/20 to-sky-500/20 border border-sky-500/30 flex items-center justify-center relative rounded-xl overflow-hidden group shadow-[inset_0_0_15px_rgba(56,189,248,0.1)]">
                        <span
                            class="text-xl md:text-3xl font-black text-sky-400 group-hover:scale-110 transition-transform select-none">ES</span>
                    </div>
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-4 flex flex-col">
                    <div
                        ...
                        <div class="flex items-center gap-2 text-sky-400 border-b border-sky-500/10 pb-1.5">
                            <Code2 :size="14" />
                            <span class="text-[10px] uppercase tracking-wider font-bold">Verified_Tech_Stack</span>
                        </div>
                        <div class="space-y-2.5">
                            <div v-for="tech in techStack" :key="tech.name" class="space-y-1">
                    ...
                    <div
                        class="grid grid-cols-1 sm:grid-cols-2 gap-3 bg-[#050a15]/70 border border-sky-500/15 p-4 rounded-2xl shadow-[inset_0_0_20px_rgba(56,189,248,0.02)]">
                        <div class="space-y-2">
                            <div class="flex items-center gap-1.5 text-sky-400 border-b border-sky-500/10 pb-1">
                                <Languages :size="12" />
                                <span class="text-[9px] uppercase tracking-wider font-bold">Languages</span>
                            </div>
                            <div class="space-y-1 text-[10px]">
                                <div class="flex justify-between"><span class="text-slate-300">Czech:</span> <span
                                        class="text-slate-500">Native</span></div>
                                <div class="flex justify-between"><span class="text-slate-300">English:</span> <span
                                        class="text-emerald-400 font-bold">B2-C1</span></div>
                                <div class="flex justify-between"><span class="text-slate-300">German:</span> <span
                                        class="text-emerald-400 font-bold">B2-C1</span></div>
                            </div>
                        </div>
                        <div class="space-y-2">
                            <div class="flex items-center gap-1.5 text-fuchsia-400 border-b border-fuchsia-500/10 pb-1">
                                <GraduationCap :size="12" />
                                <span class="text-[9px] uppercase tracking-wider font-bold">Certificates</span>
                            </div>
                ...
                <div
                    class="space-y-4 bg-[#050a15]/70 border border-fuchsia-500/15 p-4 rounded-2xl flex flex-col justify-start shadow-[inset_0_0_20px_rgba(217,70,239,0.02)]">
                    ...
                    <div class="relative pl-3 border-l border-sky-500/40 space-y-1">
                        <div class="text-[11px] font-bold text-white tracking-wide">Technical Support Specialist</div>
                        <div class="text-[9px] text-sky-400 font-bold">GoPay / Fintech Branch (03/2024 - Present)</div>
                        <p class="text-[10px] text-slate-400 font-sans md:font-mono leading-relaxed">
                            Debugging and integration troubleshooting of merchant payment systems using REST APIs and
                            legacy SOAP. Investigating core application failures and system monitoring via Kibana,
                            Grafana, and OpenSearch. Contributing to OpenSource module improvements (WooCommerce,
                            PrestaShop).
                        </p>
                    </div>
...
<file path="resources/js/Components/NeonCommentSection.vue">
<script setup>
...
<file path="resources/js/Components/NeonUserProfile.vue">
<script setup>
import { computed } from 'vue';
import { useNotificationStore } from '@/Stores/useNotificationStore';
...
<file path="app/Jobs/HandleAgentResponse.php">
<?php
    ...
    'apps' => [
        ...
        'apps' => [
            [
                ...
                'app_id' => env('REVERB_APP_ID'),
                'options' => [
                    'host' => env('REVERB_HOST', 'neon-hub.test'),
...
<file path="resources/css/neon-ui.css">
/* Definice animací, aby byly dostupné globálně */
...
<file path="resources/js/Components/NeonGate.vue">
<script setup>
defineProps({
    isOpened: {
        type: Boolean,
...
<template>
    <div class="fixed inset-0 flex overflow-hidden pointer-events-none z-[100]">

        <div class="gate-wing w-1/2 h-full bg-[#03060f] border-r-[1px] border-sky-500/10 transition-transform duration-[1800ms] ease-in-out pointer-events-auto flex items-start justify-center"
            :style="isOpened ? 'transform: translate3d(-100%, 0, 0)' : 'transform: translate3d(0, 0, 0)'">

            <div class="mt-[15vh] px-2 md:px-12 text-center">
                <h1
                    class="text-5xl sm:text-7xl md:text-9xl font-black text-white tracking-tighter select-none leading-none opacity-90 uppercase">
                    NEON
                </h1>
            </div>
        </div>

        <div class="gate-wing w-1/2 h-full bg-[#03060f] border-l-[1px] border-sky-500/10 transition-transform duration-[1800ms] ease-in-out pointer-events-auto flex items-start justify-center"
            :style="isOpened ? 'transform: translate3d(100%, 0, 0)' : 'transform: translate3d(0, 0, 0)'">

            <div class="mt-[15vh] px-2 md:px-12 text-center">
                <h1
                    class="text-5xl sm:text-7xl md:text-9xl font-black text-sky-400 tracking-tighter select-none leading-none opacity-90 uppercase">
                    HUB
                </h1>
            </div>
        </div>
...
<file path="tests/Feature/SystemAlertTest.php">
<?php
...
<file path="app/Http/Controllers/NeonHubController.php">
<?php
...
<file path="resources/js/Components/NeonMessages.vue">
<script setup>
...
<file path="resources/js/Components/NeonOverlay.vue">
<script setup>
// Data vytažená bokem - čistý kód
const MANIFEST_ITEMS = [
    { t: 'Bleeding Edge', v: 'Laravel 13 Core' },
    { t: 'Interface', v: 'Vue 3 & Tailwind' },
    { t: 'Architecture', v: 'Clean & Scalable' }
];
...
<template>
    <div v-if="!isOpened"
        ...
        <div class="flex-1 flex items-center justify-center w-full px-5 md:px-6 py-4 shrink-0"
            ...
            <div
                class="relative group p-[1px] md:p-[2px] rounded-[1.8rem] md:rounded-[2.5rem] overflow-hidden max-w-sm md:max-w-lg w-full scale-[0.98] md:scale-[0.92]">
                ...
                <div
                    ...
                    <div class="space-y-4 md:space-y-8">
                        <div v-for="(item, i) in MANIFEST_ITEMS" :key="i"
                            ...
                            <p
                                class="text-slate-100 text-[15px] md:text-2xl font-light tracking-tight leading-tight flex-1">
                                <span class="text-white font-bold border-b border-sky-500/30">{{ item.t }}:</span>
                                <br class="md:hidden" />
                                <span class="md:inline-block md:ml-1">{{ item.v }}</span>
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div
            ...
            <p
                class="text-slate-600 text-[7px] md:text-[11px] uppercase tracking-[0.5em] md:tracking-[1em] animate-pulse font-bold text-center">
                Identity Verified // Waiting For Input
            </p>
        </div>
    </div>
...
.rotating-border {
    ...
    /* Změna: přidali jsme jen transform-origin a scale, aby animace rotovala čistě */
...
<file path="resources/js/Components/NeonFriends.vue">
<script setup>
import { ref } from 'vue';
import { storeToRefs } from 'pinia';
import { useNotificationStore } from '@/Stores/useNotificationStore';
...
<file path="resources/js/Components/NeonNav.vue">
<script setup>
import { Cpu, FileUser } from 'lucide-vue-next';
...
<template>
    <header class="fixed top-0 left-0 w-full z-[60]">
        <div class="neon-panel-wrapper nav-wrapper h-16 border-b border-white/5">
            ...
            <div class="neon-glass-core h-full !flex-row items-center justify-between px-4 md:px-12 bg-[#050914]/95">

                <div class="flex items-center gap-2 md:gap-3 md:w-64 shrink-0">
                    <div class="relative group cursor-pointer">
                        <div
                            class="absolute -inset-2 bg-sky-500/20 blur-md rounded-full opacity-0 group-hover:opacity-100 transition-opacity">
                        </div>
                        <Cpu :size="20" class="text-sky-400 relative md:scale-110" />
                    </div>
                    <span class="font-black text-lg md:text-xl uppercase tracking-tighter text-white select-none">
                ...
                <div class="flex flex-1 justify-center items-center px-1 md:px-10 lg:px-20 min-w-0">
                    ...
                    <div class="hidden md:flex items-center gap-3.5 bg-slate-950/80 border border-sky-500/30 px-5 py-1.5 rounded-full shadow-[0_0_15px_rgba(56,189,248,0.12)] hover:border-fuchsia-500/60 hover:shadow-[0_0_25px_rgba(192,43,155,0.3)] transition-all duration-300 cursor-pointer group active:scale-98"
                        ...
                        <div class="flex items-center gap-2.5">
                            ...
                            <span
                                class="text-[9px] font-mono text-sky-400/60 uppercase tracking-wider group-hover:text-fuchsia-400/70 transition-colors">System
                                Author:</span>
                            <span
                                class="text-xs font-semibold text-sky-100 group-hover:text-white transition-colors tracking-wide">Erik
                                Sternad</span>
                        </div>

                        <div class="h-3.5 w-[1px] bg-sky-500/20 group-hover:bg-fuchsia-500/30 transition-colors"></div>
                    ...
                    <button
                        ...
                        <span class="text-[9px] font-mono font-bold tracking-wider uppercase">CV</span>
                ...
                <div
                    class="flex items-center justify-end gap-2 md:gap-4 md:w-64 max-w-[140px] xs:max-w-[180px] sm:max-w-none shrink-0">
                    ...
                    <div class="relative group shrink-0">
                        ...
                        <div
                            class="relative w-8 h-8 md:w-9 md:h-9 rounded-full bg-gradient-to-tr from-fuchsia-600 to-sky-400 p-[1px]">
...
<file path="resources/js/Components/NeonSocialFeed.vue">
<script setup>
...
<file path="resources/js/Components/NeonSocialActions.vue">
<script setup>
import { computed } from 'vue';
...
<file path="resources/js/Components/NeonTechDashboard.vue">
<script setup>
...
<file path="resources/js/Components/NeonSocialPost.vue">
<script setup>
import { ref } from 'vue';
...
messages: [],
    ...
    actions: {
        ...
        addMessage(message) {
            ...
            // Extrahovat jméno bota z agent_name nebo z agent položky
            let senderName = message.sender || message.role || "UNKNOWN";
            let agentName = message.agent_name || message.agentName || "";

            // Pokud je sender "BOT" a máme agent_name, použijeme agent_name jako sender
            if (senderName === "BOT" && agentName) {
        ...
        updateFriendRequestStatus(id, newStatus) {
            ...
            if (req) {
                ...
                if (newStatus === "accepted") {
                    this.addFriend(req);
                    // BONUS SENIOR FIX: Jakmile žádost přijmeš, rovnou ji smažeme z pole requestů,
                    // aby ti ta zbytečně nezůstávala viset v paměti storu.
                    this.removeFriendRequest(id);
                }
            }
        },
        ...
        initListeners() {
            ...
            // Reload zpráv při focusu okna
            window.addEventListener("focus", () => {
                this.fetchMessages();
            });

            // Poslouchání na privátním kanálu uživatele ID 1 (recruiter)
            // Tím se zajišťuje že AI posty jsou vidět
            ...
            // Poslouchání na veřejném kanálu pro sociální akce (posty, lajky, komentáře)
            window.Echo.channel("posts")
                .listen(".PostCreated", (e) => this.addPost(e.data || e.post))
                .listen(".PostLiked", (e) => {
                    const post = this.posts.find(
...
<file path="resources/js/Components/NeonSocialCore.vue">
<script setup>
import { ref, watch } from 'vue';
import { useNotificationStore } from '@/Stores/useNotificationStore';
...
use App\Ai\Agents\AIAgent; // <-- OPRAVENO: Import nového generického agenta
use App\Events\MessageReceived;
use App\Events\NewActivityAlert;
use App\Events\PostCreated;
use App\Models\Post;
...
use Queueable;
    ...
    public function handle(): void
    {
        ...
        // 📡 4. GENEROVÁNÍ PŘES LLM
        $aiResponse = $agentInstance->prompt($prompt, provider: [
            'gemini',
            'gemini_fallback',
            'groq',
        ])->text;
        ...
        DB::table('agent_conversation_messages')->insert([
            ...
            'conversation_id' => $conversationId,
            'user_id' => $user->id,
            'agent' => AIAgent::class, // <-- OPRAVENO: Ukládáme správnou třídu do logu
            'role' => 'assistant',
            'content' => $aiResponse,
            'attachments' => '[]', 'tool_calls' => '[]', 'tool_results' => '[]', 'usage' => '[]', 'meta' => '[]',
            'created_at' => $now,
        ...
        event(new MessageReceived($user->id, [
            'id' => $newMessageId,
            'conversation_id' => $conversationId,
            'agent' => AIAgent::class, // <-- OPRAVENO: Posíláme správnou třídu na frontend
        ...
        // 🌐 7. GENEROVÁNÍ FEED POSTU POD IDENTITOU BOTA
        $alertMessage = "User {$agentUser->name} has created a new post!";

        $postContent = ! $lastMessage
            ? "NETWORK_ALERT: New node connection established with subject [{$user->name}]. Telemetry sync initialized by [{$agentUser->name}]."
            : "DATA_STREAM: Processing incoming packets from node [{$user->name}]. System responses shifting under [{$agentUser->name}] protocol.";
    ...
    actions: {
        ...
        async fetchMessages() {
            try {
                ...
                // Zachrání broadcastovaných zpráv před přepisem
        ...
        async sendReply(messageId, text) {
            try {
                ...
                // Obohacujeme data dřív, než je pošleme do addMessage
                const myMessage = {
                    ...response.data,
                    sender: "YOU",
                    role: "user",
                    read: true, // Tvoje vlastní zpráva je logicky přečtená
                };
        ...
        /**
         * SENIOR FIX: Opravené smazání konverzace z backendu i lokálního stavu storu
         */
        async deleteConversation(conversationId) {
            try {
                // Skutečné odpálení DELETE požadavku na tvůj MessageController@destroy
                await axios.delete(`/messages/${conversationId}`);

                // Vyčištění lokálního reaktivního stavu storu (zprávy zmizí z UI)
                this.messages = this.messages.filter(
                    (m) => String(m.conversation_id) !== String(conversationId),
                );
                return true;
        ...
        addMessage(message) {
            ...
            // FIX: Poznáme, jestli zprávu posíláš ty, nebo letí z WebSocketu od bota
            ...
            const normalized = {
                ...
                // Pokud je moje, je přečtená. Pokud je od bota, drží si stav nebo padá do false (nepřečtená)
                read: isOwnMessage
                    ? true
                    : msg.read === true ||
                      msg.read === 1 ||
        ...
        initListeners() {
            ...
            window.Echo.private(`App.Models.User.1`)
                ...
                .listen("MessageReceived", (e) => {
                    console.log("WebSocket: Nová zpráva přijata:", e);
                    this.addMessage(e);
                })
                .listen(".NewActivityAlert", (e) => {
                    this.addAlert({ title: "SYSTEM_ALERT", msg: e.message });
            ...
            window.Echo.channel("posts")
                ...
                .listen(".PostLiked", (e) => {
                    ...
                    const userName = e.user?.name || e.userName || "BOT";
                    ...
                    if (
                        ...
                        const oldLikes = Number(post.likes_count);
                        const newLikes = Number(e.likesCount);
